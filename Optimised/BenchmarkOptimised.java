...
/**
 * COS 730 -- Assignment 2 -- Task 6 Benchmark (Optimised)
 *
 * HOW TO RUN:
 *   1. Place this file inside the Optimised/ folder
 *   2. cd Optimised
 *   3. javac *.java
 *   4. java BenchmarkOptimised
 *
 * Take a screenshot of the output for the report.
 */
public class BenchmarkOptimised {
    ...
    static final String[] CLASSES = {
        ...
        "Researcher", "SubmissionController", "NotificationListener"
    };

    public static void main(String[] args) throws Exception {
        System.out.println("╔══════════════════════════════════════════════════════════╗");
        System.out.println("║   COS 730 -- Task 6 -- OPTIMISED Benchmark               ║");
        System.out.println("╚══════════════════════════════════════════════════════════╝");
        ...
        System.out.println("  Total interactions per submission: 28");
        System.out.println("  (traced from optimised sequence diagram)");
        System.out.println();
        ...
        try (BufferedWriter w = new BufferedWriter(
                new FileWriter("benchmark_optimised.txt"))) {
            w.write("OPTIMISED -- avg: " + String.format("%.4f", ms)
                    + " ms/submission\n");
            w.write("Throughput: " + String.format("%.0f", tput)
                    + " submissions/sec\n");
        }
        System.out.println("Saved to benchmark_optimised.txt");
    }
